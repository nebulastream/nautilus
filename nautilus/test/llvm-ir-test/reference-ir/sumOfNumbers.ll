...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi7 = phi <8 x i32> [ zeroinitializer, %vector.ph ], [ %7, %vector.body ]
  %vec.phi8 = phi <8 x i32> [ zeroinitializer, %vector.ph ], [ %8, %vector.body ]
  %vec.phi9 = phi <8 x i32> [ zeroinitializer, %vector.ph ], [ %9, %vector.body ]
  ...
  %6 = add <8 x i32> %vec.ind, %vec.phi
  %7 = add <8 x i32> %step.add, %vec.phi7
  %8 = add <8 x i32> %step.add.2, %vec.phi8
  %9 = add <8 x i32> %step.add.3, %vec.phi9
...
middle.block:                                     ; preds = %vector.body
  ...
  %bin.rdx10 = add <8 x i32> %8, %bin.rdx
  %bin.rdx11 = add <8 x i32> %9, %bin.rdx10
  %11 = tail call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> %bin.rdx11)
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %vec.phi16 = phi <4 x i32> [ %13, %vec.epilog.ph ], [ %14, %vec.epilog.vector.body ]
  %14 = add <4 x i32> %vec.ind15, %vec.phi16
  %index.next17 = add nuw i32 %index14, 4
  %vec.ind.next18 = add <4 x i32> %vec.ind15, splat (i32 4)
  %15 = icmp eq i32 %index.next17, %n.vec13
...
.lr.ph.preheader:                                 ; preds = %vec.epilog.iter.check, %vec.epilog.middle.block, %iter.check
  ...
  %.ph24 = phi i32 [ 0, %iter.check ], [ %11, %vec.epilog.iter.check ], [ %16, %vec.epilog.middle.block ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %17 = phi i32 [ %20, %.lr.ph ], [ %.ph, %.lr.ph.preheader ]
  %18 = phi i32 [ %19, %.lr.ph ], [ %.ph24, %.lr.ph.preheader ]
  %19 = add i32 %17, %18
  %20 = add i32 %17, 1
  %.not = icmp sgt i32 %20, %0
  br i1 %.not, label %._crit_edge, label %.lr.ph, !llvm.loop !5

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %vec.epilog.middle.block, %1
  %.lcssa = phi i32 [ 0, %1 ], [ %11, %middle.block ], [ %16, %vec.epilog.middle.block ], [ %19, %.lr.ph ]
  ret i32 %.lcssa
}
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %15, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !7
...
.lr.ph.i.preheader:                               ; preds = %vec.epilog.iter.check, %vec.epilog.middle.block, %iter.check
  %.ph = phi i32 [ 1, %iter.check ], [ %ind.end, %vec.epilog.iter.check ], [ %12, %vec.epilog.middle.block ]
  %.ph19 = phi i32 [ 0, %iter.check ], [ %11, %vec.epilog.iter.check ], [ %16, %vec.epilog.middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %17 = phi i32 [ %20, %.lr.ph.i ], [ %.ph, %.lr.ph.i.preheader ]
  %18 = phi i32 [ %19, %.lr.ph.i ], [ %.ph19, %.lr.ph.i.preheader ]
  %19 = add i32 %18, %17
  %20 = add i32 %17, 1
  %.not.i = icmp sgt i32 %20, %0
...
execute.exit:                                     ; preds = %.lr.ph.i, %middle.block, %vec.epilog.middle.block, %1
  %.lcssa.i = phi i32 [ 0, %1 ], [ %11, %middle.block ], [ %16, %vec.epilog.middle.block ], [ %19, %.lr.ph.i ]
  ret i32 %.lcssa.i
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %step.add.2 = add <8 x i32> %vec.ind, splat (i32 16)
  %step.add.3 = add <8 x i32> %vec.ind, splat (i32 24)
  %8 = add <8 x i32> %vec.phi, %vec.ind
  %9 = add <8 x i32> %vec.phi2, %step.add
  %10 = add <8 x i32> %vec.phi3, %step.add.2
  %11 = add <8 x i32> %vec.phi4, %step.add.3
  %index.next = add nuw i32 %index, 32
  %vec.ind.next = add <8 x i32> %vec.ind, splat (i32 32)
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index9 = phi i32 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next12, %vec.epilog.vector.body ]
  %vec.ind10 = phi <4 x i32> [ %induction, %vec.epilog.ph ], [ %vec.ind.next13, %vec.epilog.vector.body ]
  %vec.phi11 = phi <4 x i32> [ %15, %vec.epilog.ph ], [ %16, %vec.epilog.vector.body ]
  %16 = add <4 x i32> %vec.phi11, %vec.ind10
  %index.next12 = add nuw i32 %index9, 4
  %vec.ind.next13 = add <4 x i32> %vec.ind10, splat (i32 4)
  %17 = icmp eq i32 %index.next12, %n.vec8
  br i1 %17, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !10
...
.lr.ph.i.preheader:                               ; preds = %vec.epilog.iter.check, %vec.epilog.middle.block, %iter.check
  ...
  %.ph19 = phi i32 [ 0, %iter.check ], [ %13, %vec.epilog.iter.check ], [ %18, %vec.epilog.middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %19 = phi i32 [ %22, %.lr.ph.i ], [ %.ph, %.lr.ph.i.preheader ]
  %20 = phi i32 [ %21, %.lr.ph.i ], [ %.ph19, %.lr.ph.i.preheader ]
  %21 = add i32 %20, %19
  %22 = add i32 %19, 1
...
execute.exit:                                     ; preds = %.lr.ph.i, %middle.block, %vec.epilog.middle.block, %1
  %.lcssa.i = phi i32 [ 0, %1 ], [ %13, %middle.block ], [ %18, %vec.epilog.middle.block ], [ %21, %.lr.ph.i ]
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  %19 = phi i32 [ %22, %.lr.ph.i.i ], [ %.ph, %.lr.ph.i.i.preheader ]
  %20 = phi i32 [ %21, %.lr.ph.i.i ], [ %.ph19, %.lr.ph.i.i.preheader ]
  %21 = add i32 %20, %19
  %22 = add i32 %19, 1
...
_mlir_ciface_execute.exit:                        ; preds = %.lr.ph.i.i, %middle.block, %vec.epilog.middle.block, %1
  %.lcssa.i.i = phi i32 [ 0, %1 ], [ %13, %middle.block ], [ %18, %vec.epilog.middle.block ], [ %21, %.lr.ph.i.i ]
  %23 = getelementptr i8, ptr %0, i64 8
  %24 = load ptr, ptr %23, align 8
