...
define signext range(i32 10, 31) i32 @execute(i32 %0) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define signext range(i32 10, 31) i32 @_mlir_ciface_execute(i32 %0) local_unnamed_addr #1 {
