...
.lr.ph.i:                                         ; preds = %1, %.lr.ph.i
  %4 = phi i32 [ %6, %.lr.ph.i ], [ %3, %1 ]
  %5 = phi i32 [ %7, %.lr.ph.i ], [ 0, %1 ]
  %6 = sdiv i32 %4, 10
  %7 = add i32 %5, 1
  %.off.i = add i32 %4, 9
  %.not.i = icmp ult i32 %.off.i, 19
...
.lr.ph.i.i:                                       ; preds = %1, %.lr.ph.i.i
  %4 = phi i32 [ %6, %.lr.ph.i.i ], [ %3, %1 ]
  %5 = phi i32 [ %7, %.lr.ph.i.i ], [ 0, %1 ]
  %6 = sdiv i32 %4, 10
  %7 = add i32 %5, 1
  %.off.i.i = add i32 %4, 9
  %.not.i.i = icmp ult i32 %.off.i.i, 19
  br i1 %.not.i.i, label %_mlir_ciface_execute.exit, label %.lr.ph.i.i

_mlir_ciface_execute.exit:                        ; preds = %.lr.ph.i.i, %1
  %.lcssa.i.i = phi i32 [ 0, %1 ], [ %7, %.lr.ph.i.i ]
  %8 = getelementptr i8, ptr %0, i64 8
  %9 = load ptr, ptr %8, align 8
