...
define signext range(i32 0, 256) i32 @execute(i32 %0) local_unnamed_addr #0 {
  %2 = and i32 %0, 255
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define signext range(i32 0, 256) i32 @_mlir_ciface_execute(i32 %0) local_unnamed_addr #1 {
  %2 = and i32 %0, 255
  ret i32 %2
}
