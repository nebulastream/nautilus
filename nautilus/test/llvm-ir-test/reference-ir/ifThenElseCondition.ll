...
define signext range(i32 44, 86) i32 @execute(i32 %0) local_unnamed_addr #0 {
  %2 = icmp eq i32 %0, 42
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define signext range(i32 44, 86) i32 @_mlir_ciface_execute(i32 %0) local_unnamed_addr #1 {
  %2 = icmp eq i32 %0, 42
