...
define signext range(i32 1, 4) i32 @execute(i32 %0) local_unnamed_addr #0 {
  %2 = icmp slt i32 %0, 5
  br i1 %2, label %3, label %5

3:                                                ; preds = %7, %5, %1
  %4 = phi i32 [ 3, %5 ], [ 1, %1 ], [ %spec.select, %7 ]
  ret i32 %4

5:                                                ; preds = %1
  %6 = icmp samesign ult i32 %0, 11
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define signext range(i32 1, 4) i32 @_mlir_ciface_execute(i32 %0) local_unnamed_addr #1 {
  %2 = icmp slt i32 %0, 5
  br i1 %2, label %execute.exit, label %3

3:                                                ; preds = %1
  %4 = icmp samesign ult i32 %0, 11
...
execute.exit:                                     ; preds = %1, %3, %5
  %7 = phi i32 [ 3, %3 ], [ 1, %1 ], [ %spec.select.i, %5 ]
  ret i32 %7
}
...
5:                                                ; preds = %1
  %6 = icmp samesign ult i32 %3, 11
  br i1 %6, label %7, label %execute.exit
...
execute.exit:                                     ; preds = %1, %5, %7
  %9 = phi i32 [ 3, %5 ], [ 1, %1 ], [ %spec.select.i, %7 ]
...
5:                                                ; preds = %1
  %6 = icmp samesign ult i32 %3, 11
  br i1 %6, label %7, label %_mlir_ciface_execute.exit
...
_mlir_ciface_execute.exit:                        ; preds = %1, %5, %7
  %9 = phi i32 [ 3, %5 ], [ 1, %1 ], [ %spec.select.i.i, %7 ]
  %10 = getelementptr i8, ptr %0, i64 8
  %11 = load ptr, ptr %10, align 8
  store i32 %9, ptr %11, align 4
  ret void
