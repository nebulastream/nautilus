...
define signext range(i32 1, 43) i32 @execute(i32 %0) local_unnamed_addr #0 {
  %switch.selectcmp = icmp eq i32 %0, 1
  %switch.select = select i1 %switch.selectcmp, i32 2, i32 42
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define signext range(i32 1, 43) i32 @_mlir_ciface_execute(i32 %0) local_unnamed_addr #1 {
  %switch.selectcmp.i = icmp eq i32 %0, 1
  %switch.select.i = select i1 %switch.selectcmp.i, i32 2, i32 42
...
define void @_mlir__mlir_ciface_execute(ptr readonly %0) local_unnamed_addr #2 {
  ...
  %switch.select.i.i = select i1 %switch.selectcmp.i.i, i32 2, i32 42
