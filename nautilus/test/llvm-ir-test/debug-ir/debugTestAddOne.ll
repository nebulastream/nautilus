...
define signext i32 @execute(i32 %0) !dbg !3 {
  %2 = add i32 %0, 1, !dbg !6
  ret i32 %2, !dbg !6
}

define signext i32 @_mlir_ciface_execute(i32 %0) {
  %2 = call i32 @execute(i32 %0)
  ret i32 %2
}
...
define void @_mlir__mlir_ciface_execute(ptr %0) {
  ...
  %3 = load ptr, ptr %2, align 8
  %4 = load i32, ptr %3, align 4
  %5 = call i32 @_mlir_ciface_execute(i32 %4)
  %6 = getelementptr ptr, ptr %0, i64 1
  %7 = load ptr, ptr %6, align 8
  store i32 %5, ptr %7, align 4
  ret void
