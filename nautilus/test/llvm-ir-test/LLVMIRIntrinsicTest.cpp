...
using nautilus::engine::combinedMathFunction;
...
// ============================================================================
// Cmath Tests - Combined Operations with MLIR Intrinsics Enabled
// ============================================================================

TEST_CASE("LLVM IR Intrinsic Test: combinedMathFunction (MLIR intrinsics enabled)", "[cmath][combined][intrinsics]") {
	testIntrinsicLLVMIR("combinedMathFunction_with_intrinsics", combinedMathFunction, true);
}
...
// ============================================================================
// Cmath Tests - Combined Operations with MLIR Intrinsics Disabled
// ============================================================================

TEST_CASE("LLVM IR Intrinsic Test: combinedMathFunction (MLIR intrinsics disabled)",
          "[cmath][combined][no-intrinsics]") {
	testIntrinsicLLVMIR("combinedMathFunction_without_intrinsics", combinedMathFunction, false);
}
