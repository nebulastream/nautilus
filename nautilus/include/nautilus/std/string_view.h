...
public:
	...
	val<const_iterator> begin() const {
		return invoke(+[](std::basic_string_view<CharT, Traits>* ptr) { return ptr->begin(); }, data_ptr);
	}

	val<const_iterator> cbegin() const {
		return invoke(+[](std::basic_string_view<CharT, Traits>* ptr) { return ptr->cbegin(); }, data_ptr);
	}

	val<const_iterator> end() const {
		return invoke(+[](std::basic_string_view<CharT, Traits>* ptr) { return ptr->end(); }, data_ptr);
	}
	...
	val<size_type> size() const noexcept {
		return invoke(+[](std::basic_string_view<CharT, Traits>* ptr) { return ptr->size(); }, data_ptr);
	}

	val<size_type> length() const noexcept {
		return invoke(+[](std::basic_string_view<CharT, Traits>* ptr) { return ptr->length(); }, data_ptr);
	}

	val<size_type> max_size() const noexcept {
		return invoke(+[](std::basic_string_view<CharT, Traits>* ptr) { return ptr->max_size(); }, data_ptr);
	}
	...
	val<const_pointer> data() const {
		return invoke(+[](std::basic_string_view<CharT, Traits>* ptr) { return ptr->data(); }, data_ptr);
	}
