...
//This needs to exist here, in order to inject the otherwise unused registerFunction declaration into the LLVM IR of the target module
...
//This needs to exist here, in order to inject the otherwise unused registerSymbol declaration into the LLVM IR of the target module
...
#define NAUT_INLINE __attribute__((annotate("naut_inline_v40")))