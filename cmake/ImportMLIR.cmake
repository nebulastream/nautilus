...
if (NAUTILUS_DOWNLOAD_MLIR)
    ...
    if (CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
        ...
        elseif (NES_HOST_PROCESSOR MATCHES "arm64" OR NES_HOST_PROCESSOR MATCHES "aarch64")
            ...
            message(FATAL_ERROR "Unsupported CPU architecture '${NES_HOST_PROCESSOR}' on Linux. Please provide your own MLIR installation via USE_EXTERNAL_MLIR=ON.")
        endif ()
    elseif (CMAKE_HOST_SYSTEM_NAME STREQUAL "Darwin")
        ...
        elseif (NES_HOST_PROCESSOR MATCHES "arm64" OR NES_HOST_PROCESSOR MATCHES "aarch64")
            ...
            message(FATAL_ERROR "Unsupported CPU architecture '${NES_HOST_PROCESSOR}' on macOS. Please provide your own MLIR installation via USE_EXTERNAL_MLIR=ON.")
        endif ()
    else ()
        message(FATAL_ERROR "${CMAKE_SYSTEM_NAME} is not supported")
    endif ()

    set(MLIR_COMPRESSED_FILE ${CMAKE_CURRENT_BINARY_DIR}/${CLANG_COMPRESSED_BINARY_NAME}.tar.gz)
