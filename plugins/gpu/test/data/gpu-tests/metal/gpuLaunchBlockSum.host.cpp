...
var_$14 = (uint32_t)1;
var_$15 = (uint32_t)1;
// Metal kernel dispatch: blockSum
{
    ...
    static id<MTLComputePipelineState> pipeline = [device newComputePipelineStateWithFunction:[library newFunctionWithName:@"blockSum"] error:&error];
    ...
    MTLSize grid = MTLSizeMake(var_$7,var_$10,var_$11);
    MTLSize block = MTLSizeMake(var_$12,var_$14,var_$15);
