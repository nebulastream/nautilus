...
define void @execute(ptr readonly %0, ptr readonly %1, ptr readonly %2, ptr readonly %3, ptr readonly %4, ptr writeonly initializes((0, 64)) %5) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @_mlir_ciface_execute(ptr readonly %0, ptr readonly %1, ptr readonly %2, ptr readonly %3, ptr readonly %4, ptr writeonly initializes((0, 64)) %5) local_unnamed_addr #0 {
  %7 = load <16 x float>, ptr %0, align 64
  %8 = load <16 x float>, ptr %1, align 64
  %9 = load <16 x float>, ptr %2, align 64
  %10 = load <16 x float>, ptr %3, align 64
