...
define float @execute(ptr readonly %0) local_unnamed_addr #0 {
  ...
  %3 = tail call reassoc float @llvm.vector.reduce.fadd.v4f32(float 0.000000e+00, <4 x float> %2)
  ret float %3
}
...
define void @_mlir_execute(ptr readonly %0) local_unnamed_addr #2 {
  ...
  %5 = tail call reassoc float @llvm.vector.reduce.fadd.v4f32(float 0.000000e+00, <4 x float> %4)
