...
define void @execute(ptr readonly %0, ptr readonly %1, ptr readonly %2, ptr readonly %3, ptr writeonly initializes((0, 64)) %4) local_unnamed_addr #0 {
  %6 = load <16 x float>, ptr %1, align 64
  %7 = load <16 x float>, ptr %0, align 64
  %8 = fmul <16 x float> %6, %7
  %9 = load <16 x float>, ptr %3, align 64
  %10 = load <16 x float>, ptr %2, align 64
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @_mlir_ciface_execute(ptr readonly %0, ptr readonly %1, ptr readonly %2, ptr readonly %3, ptr writeonly initializes((0, 64)) %4) local_unnamed_addr #0 {
  %6 = load <16 x float>, ptr %1, align 64
  %7 = load <16 x float>, ptr %0, align 64
  %8 = fmul <16 x float> %6, %7
  %9 = load <16 x float>, ptr %3, align 64
...
define void @_mlir_execute(ptr readonly %0) local_unnamed_addr #1 {
  ...
  %16 = load <16 x float>, ptr %6, align 64
  %17 = load <16 x float>, ptr %3, align 64
  %18 = fmul <16 x float> %16, %17
  %19 = load <16 x float>, ptr %12, align 64
  %20 = load <16 x float>, ptr %9, align 64
