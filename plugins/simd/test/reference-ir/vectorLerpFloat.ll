...
define void @execute(ptr readonly %0, ptr readonly %1, ptr readonly %2, ptr writeonly %3) local_unnamed_addr #0 {
  ...
  %8 = fsub <16 x float> %6, %5
  %9 = tail call <16 x float> @llvm.fma.v16f32(<16 x float> %7, <16 x float> %8, <16 x float> %5)
...
define void @_mlir_execute(ptr readonly %0) local_unnamed_addr #2 {
  ...
  %16 = fsub <16 x float> %14, %13
  %17 = tail call <16 x float> @llvm.fma.v16f32(<16 x float> %15, <16 x float> %16, <16 x float> %13)
