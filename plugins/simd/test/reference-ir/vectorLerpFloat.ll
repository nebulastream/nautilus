...
define void @execute(ptr readonly %0, ptr readonly %1, ptr readonly %2, ptr writeonly initializes((0, 16)) %3) local_unnamed_addr #0 {
  ...
  %9 = tail call <4 x float> @llvm.fma.v4f32(<4 x float> %7, <4 x float> %8, <4 x float> %5)
...
define void @_mlir_execute(ptr readonly %0) local_unnamed_addr #2 {
  ...
  %16 = fsub <4 x float> %14, %13
  %17 = tail call <4 x float> @llvm.fma.v4f32(<4 x float> %15, <4 x float> %16, <4 x float> %13)
