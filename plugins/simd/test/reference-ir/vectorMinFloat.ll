...
define void @execute(ptr readonly %0, ptr readonly %1, ptr writeonly initializes((0, 16)) %2) local_unnamed_addr #0 {
  ...
  %6 = tail call <4 x float> @llvm.minnum.v4f32(<4 x float> %4, <4 x float> %5)
  store <4 x float> %6, ptr %2, align 16
  ret void
}
...
define void @_mlir_execute(ptr readonly %0) local_unnamed_addr #2 {
  ...
  %12 = tail call <4 x float> @llvm.minnum.v4f32(<4 x float> %10, <4 x float> %11)
