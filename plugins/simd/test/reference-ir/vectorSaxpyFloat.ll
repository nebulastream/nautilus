...
define void @execute(ptr readonly %0, ptr %1, ptr readonly %2) local_unnamed_addr #0 {
  ...
  %7 = tail call <4 x float> @llvm.fma.v4f32(<4 x float> %6, <4 x float> %4, <4 x float> %5)
...
define void @_mlir_execute(ptr readonly %0) local_unnamed_addr #2 {
  ...
  %11 = load <4 x float>, ptr %6, align 16
  %12 = load <4 x float>, ptr %9, align 16
  %13 = tail call <4 x float> @llvm.fma.v4f32(<4 x float> %12, <4 x float> %10, <4 x float> %11)
