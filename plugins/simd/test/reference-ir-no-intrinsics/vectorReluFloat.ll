...
define void @execute(ptr %0, ptr %1, ptr %2) local_unnamed_addr #0 {
  ...
  %7 = tail call ptr @runtimeFunc2(ptr %6, ptr %4, ptr %5)
  tail call void @runtimeFunc3(ptr %2, ptr %7)
  ret void
}
...
; Function Attrs: memory(readwrite)
declare ptr @runtimeFunc2(ptr, ptr, ptr) local_unnamed_addr #1

; Function Attrs: memory(readwrite)
declare void @runtimeFunc3(ptr, ptr) local_unnamed_addr #1
...
define void @_mlir_execute(ptr readonly %0) local_unnamed_addr #0 {
  ...
  %13 = tail call ptr @runtimeFunc2(ptr %12, ptr %10, ptr %11)
  tail call void @runtimeFunc3(ptr %9, ptr %13)
  ret void
}
