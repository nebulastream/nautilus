...
define void @execute(ptr %0, ptr %1, ptr %2) local_unnamed_addr #0 {
  ...
  %6 = tail call ptr @runtimeFunc1(ptr %5, ptr %4)
...
define void @_mlir_execute(ptr readonly %0) local_unnamed_addr #0 {
  ...
  %10 = tail call ptr @runtimeFunc0(ptr %6)
  %11 = tail call ptr @runtimeFunc0(ptr %3)
  %12 = tail call ptr @runtimeFunc1(ptr %11, ptr %10)
