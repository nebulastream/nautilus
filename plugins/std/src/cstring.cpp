...
val<char*> strncpy(val<char*> s1, const val<char*> s2, val<size_t> n) noexcept {
	return invoke<char*, char*, const char*, size_t>(std::strncpy, s1, s2, n);
}
val<char*> strcat(val<char*> s1, const val<char*> s2) noexcept {
	return invoke<char*, char*, const char*>(std::strcat, s1, s2);
}
val<char*> strncat(val<char*> s1, const val<char*> s2, val<size_t> n) noexcept {
