...
public:
	void registerIntrinsics(MLIRIntrinsicManager& manager) override {
		...
		manager.addIntrinsic(reinterpret_cast<void*>(&nautilus_assume_constant_stub),
		                     [](std::unique_ptr<::mlir::OpBuilder>& builder, const compiler::ir::CallOperation* call,
		                        MLIRLoweringProvider::ValueFrame& frame) -> bool {
			                     ...
			                     auto cmp =
			                         ::mlir::arith::CmpIOp::create(*builder, builder->getUnknownLoc(),
			                                                       ::mlir::arith::CmpIPredicate::eq, value, expected);
			                     ::mlir::LLVM::AssumeOp::create(*builder, builder->getUnknownLoc(), cmp);
			                     return true;
		                     });
		manager.addIntrinsic(reinterpret_cast<void*>(&nautilus_assume_range_stub),
		                     [](std::unique_ptr<::mlir::OpBuilder>& builder, const compiler::ir::CallOperation* call,
		                        MLIRLoweringProvider::ValueFrame& frame) -> bool {
			                     auto value = frame.getValue(call->getInputArguments()[0]->getIdentifier());
			                     ...
			                     auto geLo = ::mlir::arith::CmpIOp::create(
			                         *builder, builder->getUnknownLoc(), ::mlir::arith::CmpIPredicate::sge, value, lo);
			                     auto leHi = ::mlir::arith::CmpIOp::create(
			                         *builder, builder->getUnknownLoc(), ::mlir::arith::CmpIPredicate::sle, value, hi);
		...
		manager.addIntrinsic(reinterpret_cast<void*>(&nautilus_assume_aligned_stub),
		                     [](std::unique_ptr<::mlir::OpBuilder>& builder, const compiler::ir::CallOperation* call,
		...
		manager.addIntrinsic(reinterpret_cast<void*>(&nautilus_assume_separate_storage_stub),
		                     [](std::unique_ptr<::mlir::OpBuilder>& builder, const compiler::ir::CallOperation* call,
		                        [[maybe_unused]] compiler::mlir::MLIRLoweringProvider::ValueFrame& frame) -> bool {
			                     auto constOp = ::mlir::arith::ConstantOp::create(
			                         *builder, builder->getUnknownLoc(), builder->getI1Type(),
